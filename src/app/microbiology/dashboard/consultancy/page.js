...
import { FaSearch, FaTimes, FaDownload,  FaCheck, FaRegFile, FaFilter } from 'react-icons/fa';
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <main className="flex-1 bg-gray-100 p-5">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[350px,1fr] gap-5 ">
                ...
                <div className="bg-white rounded-xl p-4 h-[calc(100vh-180px)] flex flex-col shadow-sm  border border-gray-200">
